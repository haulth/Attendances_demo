...
def student_view_attendance(request):
    ...
    if request.method != 'POST':
        ...
        context = {
            ...
            'page_title': 'Xem tình trạng điểm danh'
        }
    ...
    if request.method == 'POST':
        if form.is_valid():
            try:
                ...
                obj.save()
                messages.success(
                    request, "Đơn xin nghỉ phép đã được nộp để xem xét.")
                return redirect(reverse('student_apply_leave'))
            except Exception:
                messages.error(request, "Không thể gửi")
        else:
            messages.error(request, "Mẫu đơn bị lỗi!")
    ...
    if request.method == 'POST':
        if form.is_valid():
            try:
                ...
                obj.save()
                messages.success(
                    request, "Phản hồi đã được gửi để xem xét.")
